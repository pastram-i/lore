...
Hooks.once('init', async function() {
  ...
  Actors.registerSheet("lore", LoreActorSheet, { makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("lore", LoreItemSheet, { makeDefault: true });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.lore.rollItemMacro("${item.name}");`;
